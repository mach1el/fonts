...
PSF_U_10646 = ter-x12n.psf ter-x14n.psf ter-x14b.psf ter-x16n.psf ter-x16b.psf ter-x18n.psf ter-x18b.psf ter-x20n.psf ter-x20b.psf ter-x22n.psf ter-x22b.psf ter-x24n.psf ter-x24b.psf ter-x28n.psf ter-x28b.psf ter-x32n.psf ter-x32b.psf
...
VGA_U_10646 = uni/vgagr.uni uni/10646-1.uni
...
$(PSF_U_10646): ter-x%.psf : ter-u%.bdf $(VGA_U_10646)
	$(UCS2VGA) $< $(REG_U_10646) $(VGA_U_10646) | $(BDF2PSF) -o $@
...
PCF_N12 = $(filter-out ter-%12b.pcf,$(PCF))
PCF_N12_646 = $(filter-out ter-%12b.pcf,$(PCF_U_10646))
...
.PHONY: all psf txt raw pcf install uninstall fontdir install-psf uninstall-psf install-ref uninstall-ref install-acm install-uni install.raw uninstall.raw install-raw uninstall-raw install-pcf uninstall-pcf clean
